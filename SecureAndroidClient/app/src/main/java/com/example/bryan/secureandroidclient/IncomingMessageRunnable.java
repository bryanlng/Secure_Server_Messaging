...
public class IncomingMessageRunnable implements Runnable {
     ...
     */
    public IncomingMessageRunnable(String address, int port, MessagesFragment mFrag){
...
//                Log.i(TAG, "timestamp in Long: " + timestamp);
                ...
                //Create a MessageItem using the fields, then add the MessageItem to the MessageFragment's listview
